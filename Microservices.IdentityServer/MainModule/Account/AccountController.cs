...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        // Certifique-se de que _handlerProvider está injetado no construtor
        ...
        private async Task<LoggedOutViewModel> BuildLoggedOutViewModelAsync(string logoutId)
        {
            ...
            if (User?.Identity.IsAuthenticated == true)
            {
                ...
                if (idp != null && idp != Duende.IdentityServer.IdentityServerConstants.LocalIdentityProvider)
                {
                    ...
                    // 1. Obtém o handler do esquema de autenticação
                    var handler = await _handlerProvider.GetHandlerAsync(HttpContext, idp);

                    // 2. Verifica se o handler suporta a funcionalidade de SignOut
